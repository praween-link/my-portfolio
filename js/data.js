...
const projectsData = [
    {
        ...
        "android": "https://drive.google.com/drive/folders/1BJM7p_8KiZ0oOgnJ_2Qqda4LXyumnpuG?usp=drive_link",
    },
    {
        "id": "02",
        "name": "BluBin",
        "sub_title": "Application (Android & IOS)",
        "about": "BluBin is a revolutionary app designed to simplify waste management and promote environmental stewardship. With its intuitive interface and powerful features, BluBin allows users to request trash pick-up services from any location with ease. Whether you're a homeowner, event organizer, or business, BluBin connects you with reliable trash collectors who efficiently remove waste. Users earn points based on the weight of collected trash, which can be redeemed for valuable discounts on products and services. By incentivizing responsible waste disposal, BluBin not only helps keep communities clean but also rewards users for their eco-friendly actions, fostering a cleaner, greener future for all.",
        "key_points": [
    ...
    },
    {
        ...
        "name": "OwnUrHealth",
        "sub_title": "Application (Android & IOS)",
        "about": `ownUrHealth™ is a state-of-the-art digital healthcare platform built with Flutter for Android and iOS devices. Operated by The Center for Healthcare Education, Research & Innovation (C.H.E.R.I.), its mission is to enhance access to healthcare services and improve health outcomes.
